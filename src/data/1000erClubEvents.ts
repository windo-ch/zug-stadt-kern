...
**AGIR PAS SUBIR**`,
  ...
  },
  {
    ...
    content: `So lautet der Titel der Tischrede von Urs Furrer, Direktor des Schweizerischen Gewerbeverbands, anlässlich des Treffens des 1000er-Clubs der SVP Stadt Zug.

**Nanny Staat – Beispiele gefällig?**

Wenn das Bundesamt für Gesundheit sich anschickt, Schokolade-Osterhasen oder Weihnachtsgebäck als schädlich für die Gesundheit (Achtung: Zucker!) zu deklarieren und somit mittels Warnhinweisen einen Verkaufsstopp anvisiert, oder wenn die Verwaltung der Stadt Zürich den Pro-Kopf-Verzehr von Fleischprodukten auf ein Maximum von 330 g pro Woche beschränken will – beides notabene flankiert und „beworben" mit lauten Kampagnen, die vom Steuerzahler finanziert werden müssen –, ist dies nicht nur bevormundend, sondern auch ein klarer Eingriff in die Privatsphäre und Entscheidungsfreiheit jeder Einwohnerin und jedes Einwohners.
...
**Eigenverantwortung statt Staatskontrolle**
...
Welche Lösungen gibt es, um den Nanny-Staat einzuschränken?
